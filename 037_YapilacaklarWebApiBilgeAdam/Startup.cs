using _037_YapilacaklarWebApiBilgeAdam.Providers;
...
[assembly: OwinStartup(typeof(_037_YapilacaklarWebApiBilgeAdam.Startup))]
    ...
    public class Startup
    {
        ...
        private void ConfigureOAuth(IAppBuilder appBuilder)
        {
            OAuthAuthorizationServerOptions oAuthAuthorizationServerOptions = new OAuthAuthorizationServerOptions()
            {
                ...
                AccessTokenExpireTimeSpan = TimeSpan.FromDays(30), // 30 gün (geliştirme için, development)
                //AccessTokenExpireTimeSpan = TimeSpan.FromMinutes(20), // 20 dakika (production)
